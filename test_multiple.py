...
n_output = 1089
# our model
model = models.get_ISTANet_Multiple(layer_num, n_input)
...
model_dir = "OPINE_Net_Multiple_%d_group_%d_%s_Binary_Norm_%.2f_Single_%.4f" % (layer_num, group_num, ''.join([k for k in CS_ratio]), phi_weight, learning_rate)
