...
class BasicBlock(torch.nn.Module):
    def __init__(self):
        ...
        rb = common.ResBlock
        self.conv1 = conv(1,32,3,bias=False)
        self.rb2 = rb(conv,32,3,bias=False)
        self.rb3 = rb(conv,32,3,bias=False)
        self.rb4 = rb(conv,32,3,bias=False)
        self.rb5 = rb(conv,32,3,bias=False)
        self.rb55 = rb(conv,32,3,bias=False)
        self.rb555 = rb(conv,32,3,bias=False)
        self.conv6 = conv(32,1,3,bias=False)
...
model_dir = "OPINE_Net_RB_%d_group_%d_%d_Binary_Norm_%.2f_Single_%.5f" % (layer_num, group_num, CS_ratio, phi_weight, learning_rate)
